...
const Usage: React.FC = () => {
  return (
    <section className="section bg-white" id="modo-de-uso">
      <div className="container-custom">
        <h2 className="section-title">Como Usar o Mounja Fit Black</h2>
        <p className="section-subtitle text-gray-700">
          Instruções simples para maximizar seus resultados
        </p>
        
        <div className="mt-12 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <img 
              src="https://images.pexels.com/photos/7260263/pexels-photo-7260263.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" 
